...
enum RingerModeStatus { normal, vibrate, silent, unknown }
...
class AppController extends SuperController with UpgradeManger {
  ...
  void onInit() async {
    ...
    isAppBadgeSupported =
        false; // Temporarily disabled due to plugin compatibility
  ...
  void showBadge(count) {
    if (isAppBadgeSupported) {
      ...
      if (count == 0) {
        ...
        // FlutterAppBadger.updateBadgeCount(count); // Temporarily disabled
  ...
  void removeBadge() {
    // FlutterAppBadger.removeBadge(); // Temporarily disabled
  }
