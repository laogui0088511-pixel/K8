...
class StrRes {
  ...
  static String get usernameLengthHint => 'usernameLengthHint'.tr;
  static String get usernameLengthInvalid => 'usernameLengthInvalid'.tr;
  ...
  static String get invalidInvitationCode => 'invalidInvitationCode'.tr;

  static String get invitationCodeVerifyUnavailable =>
      'invitationCodeVerifyUnavailable'.tr;

  static String get authCode => 'authCode'.tr;

  static String get plsEnterAuthCode => 'plsEnterAuthCode'.tr;

  static String get invalidAuthCode => 'invalidAuthCode'.tr;
  ...
  static String get searchTooFrequent => 'searchTooFrequent'.tr;
