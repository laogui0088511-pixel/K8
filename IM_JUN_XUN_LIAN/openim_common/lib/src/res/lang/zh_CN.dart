const Map<String, String> zh_CN = {
  ...
  "usernameLengthHint": "用户名长度需为6到12位",
  "usernameLengthInvalid": "用户名长度需为6到12位",
  "phoneNumber": "手机号",
  ...
  "loginNow": "立即登录",
  "registerNow": "立即注册",
  'lockPwdErrorHint': '错误次',
  "newUserRegister": "新用户注册",
  "verificationCode": "验证码",
  "sendVerificationCode": "发送验证码",
  'resendVerificationCode': '重发验证码',
  'verificationCodeTimingReminder': 'S后重新获取验证码',
  "defaultVerificationCode": "（默认验证码：)",
  "plsEnterVerificationCode": "请输入您的验证码",
  "invitationCode": "邀请码",
  "plsEnterInvitationCode": "请输入您的邀请码",
  "invalidInvitationCode": "邀请码无效或已被使用",
  "invitationCodeVerifyUnavailable": "当前服务未部署邀请码预校验，请联系管理员更新服务端配置",
  "authCode": "授权码",
  "plsEnterAuthCode": "请输入您的授权码",
  "invalidAuthCode": "授权码无效或不可用于找回密码",
  "optional": "选填",
  "nextStep": "下一步",
  ...
  "wrongPasswordFormat": "密码需为6到20位，且至少包含字母和数字",
  "wrongNicknameFormat": "用户名长度需为6到12位",
  ...
  "you": "你",
  "groupAc": "群公告",
  "createGroupNtf": " 创建了群聊",
  "editGroupInfoNtf": " 修改了群资料",
  "quitGroupNtf": " 退出了群聊",
  "invitedJoinGroupNtf": " 邀请  加入群聊",
  "kickedGroupNtf": " 被  移出群聊",
  "joinGroupNtf": " 加入群聊",
  "dismissGroupNtf": " 解散了群聊",
  "transferredGroupNtf": " 将群管理权限转让给了 ",
  "muteMemberNtf": " 被  禁言",
  "muteCancelMemberNtf": " 被  取消了禁言",
  "muteGroupNtf": " 开起了群禁言",
  "muteCancelGroupNtf": " 关闭了群禁言",
  "friendAddedNtf": "你们已成为好友，可以开始聊天了",
  "openPrivateChatNtf": "已开启阅后即焚",
  "closePrivateChatNtf": "已关闭阅后即焚",
  "memberInfoChangedNtf": " 编辑了自己的群成员资料",
  ...
  'deletedByFriendHint': '开启了好友验证，你还不是他的好友 ',
  ...
  "webMiniOnline": "小程序",
  "upgradeFind": "发现新版本",
  "upgradeVersion": "检测到一个新的可用版本，你当前版本是",
  ...
  'groupAudioCallHint': '人正在语音通话',
  'groupVideoCallHint': '人正在视频通话',
  'reEdit': '重新编辑',
  'playSpeed': '播放速度',
  'download': '下载',
  "googleMap": "谷歌地图",
  ...
  "searchEmailIs": "邮箱：",
  "searchNicknameIs": "昵称：",
  "searchGroupNicknameIs": "群昵称：",
  "noFoundUser": "无法找到该用户",
  "noFoundGroup": "无法找到该群聊",
  "searchTooFrequent": "30秒内只能搜索一次",
  'joinGroupDate': '入群时间',
  'joinGroupMethod': '入群方式',
  'byInviteJoinGroup': '邀请进群',
  'byIDJoinGroup': '搜索群ID',
  ...
  'publish': '发布',
  'groupMember': '群成员',
  'selectedPeopleCount': '已选择（）',
  'confirmSelectedPeople': '确定(/)',
  'confirm': '确认',
  "confirmTransferGroupToUser": "确定将群主转让给：？",
  ...
  "calling": "通话中",
  "nPeopleCalling": "人正在通话中",
  'busyVideoCallHint': '有用户正忙，无法接收到你的邀请',
  "whoInvitedVoiceCallHint": "邀请你进行语音通话",
  "whoInvitedVideoCallHint": "邀请你进行视频通话",
  ...
  'meetingSubjectIs': '会议主题：',
  'meetingStartTimeIs': '开始时间：',
  'meetingDurationIs': '会议时长：',
  'meetingHostIs': '主持人：',
  'meetingNoIs': '会议号：',
  ...
  'didNotStart': '未开始',
  'started': '已开始',
  'meetingInitiatorIs': '发起的视频会议',
  'meetingDetail': '会议详情',
  'meetingOrganizerIs': '发起人：',
  ...
  'invitesYouToVideoConference': '邀请你加入视频会议',
  'over': '结束',
  'meetingMute': '静音',
  'meetingUnmute': '取消静音',
  ...
  'callFail': '你无法呼叫该用户',
  'search_by_phone_and_uid': 'ID号/搜索添加',
