...
class Urls {
  ...
  static final verifyInvitationCode =
      "${Config.appAuthUrl}/account/invitation_code/verify";
  static final register = "${Config.appAuthUrl}/account/register";

  static final resetPwd = "${Config.appAuthUrl}/account/password/reset";
  static final verifyResetPasswordCode =
      "${Config.appAuthUrl}/account/password/verify_reset_code";
